            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{ trans_choice('strings.frontend.general.you_have.messages', 4, ['number' => 4]) }}</li>
                        <li>
                        ...
                        <li class="footer"><a href="#">{{ trans('strings.frontend.general.see_all.messages') }}</a></li>
                    </ul>
                </li><!-- /.messages-menu -->
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{ trans_choice('strings.frontend.general.you_have.notifications', 0) }}</li>
                        <li>
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{ trans_choice('strings.frontend.general.you_have.tasks', 1, ['number' => 1]) }}</li>
                        <li>
                        ...
                        <li class="footer">
                            <a href="#">{{ trans('strings.frontend.general.see_all.tasks') }}</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <small>{{ trans('strings.frontend.general.member_since') }} XX/XX/XXXX</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="#" class="btn btn-default btn-flat">{{ trans('navs.frontend.button') }}</a>
                            </div>
